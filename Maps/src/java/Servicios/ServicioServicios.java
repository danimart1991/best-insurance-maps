...
@WebServlet(urlPatterns = {"/ServicioServicios"})
public class ServicioServicios extends HttpServlet {
 Gson gson=new Gson();
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      ArrayList<Profesionales> hogarP=gson.fromJson(responses.toString(), tipoObjeto3);
        } finally {
            out.close();
        }
    }
